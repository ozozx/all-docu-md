---
parent: "[[hyprland/Getting Started/Getting Started]]"
next: "[[Master Tutorial]]"
---
...
>
> This wiki is _very_ verbose. It's highly recommended to scour and read the wiki first before assuming something is not working or not available.

> [!NOTE]
> NVIDIA GPUs are often not usable out-of-the-box, follow the [[Nvidia|Nvidia page]] after installing Hyprland if you plan to use one. Blame NVIDIA for this.
...
> [!WARNING]
> It is **heavily** recommended you use **what the distro packages for you**, and **not** compiling manually or using `-git` packages.
...
>
> If you decide to use the `git` version from the AUR, you can use the [Chaotic Aur](https://aur.chaotic.cx/) to get pre-built binaries. Be aware that updating dependencies like `hyprutils` might still require you to recompile everything yourself as the Chaotic Aur does not do that automatically.
>
> > [!NOTE]
...
> ```
>
> For more details, read the [[Nix|Nix page]].
...
> ```
>
> Alternatively, you can also follow the instructions under [[#Manual|"Manual (Manual Build)"]] to build Hyprland yourself.
>
> Note: _Hyprland is not available for Leap, as most libraries (and compiler) that Hyprland needs are too old._

> [!example]- Fedora*
>
> [lionheartp/Hyprland](https://copr.fedorainfracloud.org/coprs/lionheartp/Hyprland) Copr repository.
>
...
> ```
>
> Additional packages like hyprlock, hypridle, xdg-desktop-portal-hyprland, hyprland-plugins, hyprpaper and hyprpicker are in the overlay. Some of the community-contributed scripts of [hyprwm/contrib](https://github.com/hyprwm/contrib) are also available in their own package (app-misc/grimblast, app-misc/hdrop, etc.).
>
> ```sh
...
>
> > [!WARNING]
> > Ubuntu's Hyprland is **extremely** outdated. I do not recommend using the packaged versions at all. Build the entire stack [[#Manual|manually]] instead.
>
...
>
> See
> [The xdph GitHub repo's readme](https://github.com/hyprwm/xdg-desktop-portal-hyprland). Refer to [XDPH](../../Hypr-Ecosystem/xdg-desktop-portal-hyprland) and [Ubuntu Guide For Installing And Building Hyprland Gist](https://gist.github.com/Vertecedoc4545/3b077301299c20c5b9b4db00f4ca6000) for more information.
>
> > [!WARNING]
...
Finally on the guest follow the instructions above for either [[#Installation|installing hyprland-git from the aur]] or [[#Manual|building manually]].
> [!WARNING]
