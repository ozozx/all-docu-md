...
> [!info]- NixOS
>
>On NixOS, XDPH is already enabled by the [[Hyprland on NixOS|NixOS module for Hyprland]], through `programs.hyprland.enable = true;`.
...
If the portal does not autostart, does not function when manually started, and does not produce any error logs, it's very likely your [[Environment variables#XDG Specifications|XDG env variables]] are messed up
