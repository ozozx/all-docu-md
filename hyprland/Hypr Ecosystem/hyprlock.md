...
prev: "[[hypridle]]"
next: "[[xdg-desktop-portal-hyprland]]"
---
...
Hyprlock uses the following types in addition to [[hyprland/Configuring/Basics/Variables#Variable types|Hyprland's variable types]].
...
Check out Hyprland's [[Animations|animation documentation]] for more information.
...
The [[Binds#Bind flags|bind flag]] `l` can be used to allow specific hyprland keybinds to also work while hyprlock is active (e.g. brightness/volume/media control).
...
> [!NOTE]
> Blur options are taken from hyprland. See [[Variables#blur|Variables/#blur]].

> [!quote]- Example background
>
>```ini
>background {
>    monitor =
