...
To autostart hyprsunset, add: `hyprsunset` to your `hyprland.lua`'s autostart. If Hyprland is started with [[Systemd start|uwsm]], you can use `systemctl --user enable --now hyprsunset.service`.
