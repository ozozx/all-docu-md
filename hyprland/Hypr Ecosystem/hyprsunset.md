...
To autostart hyprsunset, add: `hyprsunset` to your `hyprland.lua`'s autostart. Alternatively, use `systemctl --user enable --now hyprsunset.service` in order to use hyprsunset as a systemd user service.
