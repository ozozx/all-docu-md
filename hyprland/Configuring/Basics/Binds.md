...
See the <code>[[Dispatchers#Dispatcher List|pass]]</code> and <code>[[Dispatchers#Dispatcher List|sendshortcut]]</code> dispatchers for keybinds.
...
> [!NOTE]
> Please note that this function will _only_ work with [[xdg-desktop-portal-hyprland|XDPH]].
...
> [!NOTE]
> To get the correct name for an `unmodified_key`, refer to [[#Uncommon syms / binding with a keycode|the section on uncommon syms]]
