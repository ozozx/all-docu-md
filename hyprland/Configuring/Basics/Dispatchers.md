...
A workspace. Can be:
 - workspace object
 - workspace ID
 - workspace selector, see [[#Workspace selectors|below]]
...
| method | description |
| --- | --- |
| `exec_cmd(cmd, rules?)` | execute a command. Rules can be a table of window rule effects to apply (see [[#Executing with rules\|below]]). |
