...
For global device configs, check the [[hyprland/Configuring/Basics/Variables|Variables]] page. This page will focus on per-device configs.
...
- `tags` -> (only for keyboards / pointers)
  - provides grouping and alt-names is device specific binds (see [[Binds#Per-Device Binds|Per-Device Binds]]). comma separated list of tags
  - default: ""
