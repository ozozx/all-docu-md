...
>
> For live event handling, see the [[Expanding functionality#Events|events]].
...
Where `window` is as described [[Dispatchers#Parameter explanation|here]], and `property` is any which can be set with [[Dispatchers#setprop|setprop]].
...
See [[hyprland/Configuring/Basics/Variables|Variables]] for sections and options you can use.
