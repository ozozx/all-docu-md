...
Use the LSP for the return values (classes and their parameters) of these functions. See [[⮞⮞ Start Here ⮜⮜#Autocompletions|here]] for setting up the LSP for your code editor
