...
| --- | --- | --- |
| orientation = [o] | Sets the orientation of a workspace. For available orientations, see [[#Config\|Config->orientation]] | string |
