...
prev: "[[hyprland/Plugins/Development/Getting Started|Getting Started]]"
next: "[[Advanced]]"
---
...
Although Hyprland plugins obviously are not _required_ to follow Hyprland's formatting, naming conventions, etc. it might be a good idea to keep your code consistent. See [`.clang-format`](https://github.com/hyprwm/Hyprland/blob/main/.clang-format) in the Hyprland repo.
