...
subpages:
 ...
 - "[[Tests]]"
 - "[[Translations]]"
next: "[[hyprland/Contributing and Debugging/Contributing and Debugging|Contributing and Debugging]]"
---

PR, code styling and code FAQs are [[PR Guidelines|here]]
...
Make a copy of your config in `~/.config/hypr` called `hyprlandd.lua`. `Debug` builds automatically use `hyprlandd.lua`, but you can also pass `--config ~/path/to/conf.lua` for an override on release / different file.
