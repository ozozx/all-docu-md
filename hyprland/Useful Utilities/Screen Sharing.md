...
Make sure you have `pipewire`, `wireplumber` and <code>[[xdg-desktop-portal-hyprland]]</code> installed, enabled and running if you don't have them yet.
