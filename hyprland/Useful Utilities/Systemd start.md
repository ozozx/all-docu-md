...
prev: "[[hyprland/Useful Utilities/Hypr Ecosystem|Hypr Ecosystem]]"
---
...
>
>> [!WARNING]
>> If you use the [[Hyprland on Home Manager|Home Manager module]], make sure to disable the systemd integration, as it conflicts with uwsm.
>>
>> ```nix
>> {
...
> [!example]- GNOME Keyring PAM setup
>
