...
_Starting method:_ Automatically, via D-Bus activation, when a notification is emitted. Alternatively, autostart entry inside `hyprland.lua` can be used. The latter might be preferable, if there are several notification daemons installed on your system.
...
See the [[xdg-desktop-portal-hyprland|Hyprland Desktop Portal Page.]]
