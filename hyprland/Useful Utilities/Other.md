...
prev: "[[File Managers]]"
next: "[[hyprland/Useful Utilities/Hypr Ecosystem|Hypr Ecosystem]]"
---
...
[split-monitor-workspaces](https://github.com/Duckonaut/split-monitor-workspaces) by _Stanisław Zagórowski_: Awesome-like workspaces for Hyprland.
...
[hyprKCS](https://github.com/kosa12/hyprKCS) by _kosa12_: A fast, minimal Hyprland keybind manager written in Rust/GTK4.
...
- [hyprshade](https://github.com/loqusion/hyprshade) by _loqusion_: Utility for swapping and scheduling screen shaders; also functions as an [automatic color temperature shifter](https://en.wikipedia.org/wiki/F.lux).
...
[Monique](https://github.com/ToRvaLDz/monique) by _ToRvaLDz_: Graphical monitor configurator for Hyprland and Sway with drag-and-drop layout, profile system, and hotplug daemon for automatic configuration.
