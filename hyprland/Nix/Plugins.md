---
parent: "[[Nix]]"
prev: "[[Options & Overrides]]"
next: "[[Contributing and Debugging]]"
---
...
> [!WARNING]
> Using plugins using the syntax below requires you to be using Hyprland through the [[Hyprland on Home Manager|Home Manager module]] or the [[Hyprland on NixOS#Upstream module|upstream NixOS module]].
