---
parent: "[[Nix]]"
prev: "[[Hyprland on NixOS]]"
next: "[[Hyprland on Home Manager]]"
---

Using hyprland via Nix on distros that aren't NixOS is very simple.

First, install nix with your package manager, be that `apt`, `pacman`, `dnf`, etc. The package is almost always called `nix`.
...
Advanced users might want to use [[Hyprland on Home Manager|Home Manager]]. If you don't know what this is, just don't.
