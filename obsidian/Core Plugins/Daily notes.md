...
If your daily notes have the same structure, you can use a [[obsidian/Core Plugins/Templates|template]] to add pre-defined content to your daily notes when you create them.
