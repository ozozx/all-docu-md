You can add fields to a markdown page (a note) in three different ways - via Frontmatter, Inline fields and Implicit fields. Read more about the first two possibilities in [[Adding Metadata|"how to add metadata"]].
...
|`file.aliases`|List|A list of all aliases for the note as defined via the [[Properties\|YAML frontmatter]].|
