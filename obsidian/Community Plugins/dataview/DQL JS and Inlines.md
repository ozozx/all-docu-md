Once you've added [[Adding Metadata|useful data to relevant pages]], you'll want to actually display it somewhere or operate on it. Dataview allows this in four different ways, all of which are written in codeblocks directly in your Markdown and live-reloaded when your vault changes.

## Dataview Query Language (DQL)

The **[[Structure of a Query|Dataview Query Language]]** (for short **DQL**) is a SQL-like language and Dataviews core functionality. It supports [[Query Types|four Query Types]] to produce different outputs, [[data commands]] to refine, resort or group your result and [[obsidian/Community Plugins/dataview/Query Language Reference/Functions|plentiful functions]] which allow numerous operations and adjustments to achieve your wanted output.
...
Find a explanation how to write a DQL Query under the [[Structure of a Query|query language reference]]. If you learn better by example, take a look at the [[Examples|query examples]].
...
You can use everything available as [[Expressions|expressions]] and [[Literals|literals]] in an Inline DQL Query, including [[obsidian/Community Plugins/dataview/Query Language Reference/Functions|functions]]. Query Types and Data Commands, on the other hand, are **not available in Inlines.**
...
The dataview [[obsidian/Community Plugins/dataview/JavaScript Reference/Overview|JavaScript API]] gives you the full power of JavaScript and provides a DSL for pulling Dataview data and executing queries, allowing you to create arbitrarily complex queries and views. Similar to the query language, you create Dataview JS blocks via a `dataviewjs`-annotated codeblock:
...
Inside of a JS dataview block, you have access to the full dataview API via the `dv` variable. For an explanation of what you can do with it, see the [[Codeblock Reference|API documentation]], or the [[Codeblock Examples|API examples]].
