...
Yes! Please see the [[Other Resources|Resources]] page.

### Can I save the result of a query for reusability?

You can write reusable Javascript Queries with the [[Codeblock Reference#`dv.view(path, input)`|dv.view]] function. In DQL, beside the possibility of writing your Query inside a Template and using this template (either with the [[obsidian/Core Plugins/Templates|Core Plugin Templates]] or the popular Community Plugin [Templater](https://obsidian.md/plugins?id=templater-obsidian)), you can **save calculations in metadata fields via [[DQL JS and Inlines#Inline DQL|Inline DQL]]**, for example:
