...
You can have as many following lines as you want. Each will start with a [[Data Commands|data command]] and will re-shape the result set it received from the previous line. For example:
