...
The `FROM` statement determines what pages will initially be collected and passed onto the other commands for further filtering. You can select from any [[Sources|source]], which currently means by folder, by tag, or by incoming/outgoing links.
