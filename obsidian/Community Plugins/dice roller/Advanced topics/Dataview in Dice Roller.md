> [!warning] Usage of the features on this page requires the Obsidian plugin [[obsidian/Community Plugins/dataview/Overview|Dataview]]

## Direct list inquiries 

> [!info] This feature was added in version 9.0.0.
...
> [!cite]- Screenshot of Fantasy Statblocks inquiry
>
> ![[imgs/IMG-Dataview in Dice Roller.png]]
...
You would need to integrate the ***[[Dice Roller and Javascript|dice roller api]]*** into a `dataviewjs` ***[[Basic formatting syntax#Code blocks|code block]]*** to attempt to make a `dv.table`.
