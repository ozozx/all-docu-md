...
Here is a list of block types that Obsidian defines, which _we believe_ to be accurate, but please use it with caution:
...
You can combine rollers with defined spaces in between by using a HTML tag to create spaces. Below, we show the example submitted by _`Mikhail#2095`_ 🎉 that creates custom spacing between names.
...
> [!cite]- Screenshot of Joining Dice Lines with EM
>
> ![Dice Lines(link-broken)](https://github.com/javalent/dice-roller/blob/main/publish/images/joining-dice-with-em.png?raw=true)