...
- In [[Introduction to Bases|Bases]], nested tags are recognized by the [[obsidian/Bases/Functions#hasTag|`hasTag`]] function, so `file.hasTag("a")` will match both `#a` and `#a/b`.  
