...
3. **Value** — lets you choose the value you are comparing to. Values can include math and [[obsidian/Bases/Functions|functions]].
...
Click the code button ![[lucide-code-xml.svg#icon]] to use the **advanced filter** editor. This displays the raw [[Bases syntax|syntax]] for the filter, and can be used with more complex [[obsidian/Bases/Functions|functions]] that cannot be displayed using the point-and-click interface.
