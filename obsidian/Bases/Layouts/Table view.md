...
![[bases-noshadow.png#interface|Example of a base showing a table view with a list of books]]
...
3. Enter a formula. The formula runs over the list of values in that column (for example, using a [[obsidian/Bases/Functions|function]] like `values.reduce(...)`).
4. Save the summary.
