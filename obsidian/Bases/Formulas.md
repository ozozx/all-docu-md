...
The formula editor will autocomplete [[obsidian/Bases/Functions|function]] and property names as you type to validate your formula syntax. A green checkmark appears when your formula is valid.
...
Functions perform operations on values. The available functions depend on the type of value you're working with. See the complete list of [[obsidian/Bases/Functions]].
