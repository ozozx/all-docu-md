...
> [!info] Is your current vault in an iCloud, OneDrive, Dropbox, or other syncing folder? If **yes**, or you are **unsure**, please read [[obsidian/Obsidian Sync/Frequently asked questions#Can I use a third-party sync with Obsidian Sync?|this]] and [[Switch to Obsidian Sync]] before proceeding.
...
- Check out the [[obsidian/Obsidian Sync/Frequently asked questions|Sync FAQ]] for some answers to common questions.
