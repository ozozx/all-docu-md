...
Files synced to your [[Local and remote vaults|remote vault]] contribute to your [[obsidian/Obsidian Sync/Frequently asked questions#How large can each remote vault be|storage limit]]. By default, Obsidian Sync activates **selective sync** for the following file types:
- Images
- Audio
- Videos
- PDFs
