...
> [!faq]- Staged/Unstaged Differences:
...
> After:
> ![[git/git-diagrams.excalidraw.md#^group=1AuZS7vf0iwXGlkJ9Ypxq|after-ff-merge]]
> #### Copy one commit onto the current branch:
> `git cherry-pick <commit>`
> Before:
> ![[git/git-diagrams.excalidraw.md#^group=tHJkRqmtD1Evcl2Ghvs5p|before-cherry-pick]]
> After:
> ![[git/git-diagrams.excalidraw.md#^group=kXHLYWMyFCzWvW7HVvq3C|after-cherry-pick]]

> [!bug]- Restore an Old File:
